...
FLUX_DEFINITIONS = {
    ...
    "signal_model": {
        "label": "🧠 Signal Model",
        "description": "LogisticRegression (calibration optionnelle) — P(up) / P(dn)",
        "category": "processing",
        "sla_latency_ms": 200,
        "config_key": "quant",
    },
    "strategy": {
        "label": "📐 Stratégie V3",
        "description": "Décision LONG/SHORT/FLAT : régime × P(up), filtre 1h, veto corrélation",
        "category": "decision",
        "sla_latency_ms": 100,
        "config_key": "quant",
    },
    "risk": {
        "label": "⚖ Risk Manager",
        "description": "Sizing ATR-based (fraction fixe) — SL/TP trailing, kill-switch hebdo",
        "category": "decision",
        "sla_latency_ms": 100,
        "config_key": "risk",
    },
