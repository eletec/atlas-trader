...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "backtest_bg_running": {
        "fr": "⏳ Backtest en cours d'exécution en arrière-plan — {elapsed}s",
        "en": "⏳ Backtest running in the background — {elapsed}s",
        "de": "⏳ Backtest läuft im Hintergrund — {elapsed}s",
        "es": "⏳ Backtest ejecutándose en segundo plano — {elapsed}s",
        "it": "⏳ Backtest in esecuzione in background — {elapsed}s",
        "pt": "⏳ Backtest a correr em segundo plano — {elapsed}s",
        "nl": "⏳ Backtest loopt op de achtergrond — {elapsed}s",
        "zh": "⏳ 回测在后台运行中 — {elapsed}秒",
    },
    "backtest_bg_progress": {
        "fr": "{done}/{total} actifs traités",
        "en": "{done}/{total} assets processed",
        "de": "{done}/{total} Assets verarbeitet",
        "es": "{done}/{total} activos procesados",
        "it": "{done}/{total} asset elaborati",
        "pt": "{done}/{total} ativos processados",
        "nl": "{done}/{total} assets verwerkt",
        "zh": "已处理 {done}/{total} 个资产",
    },
    "backtest_bg_done": {
        "fr": "✅ Backtest terminé en {elapsed}s",
        "en": "✅ Backtest finished in {elapsed}s",
        "de": "✅ Backtest in {elapsed}s abgeschlossen",
        "es": "✅ Backtest finalizado en {elapsed}s",
        "it": "✅ Backtest completato in {elapsed}s",
        "pt": "✅ Backtest concluído em {elapsed}s",
        "nl": "✅ Backtest voltooid in {elapsed}s",
        "zh": "✅ 回测已在 {elapsed}秒内完成",
    },
    "backtest_bg_error": {
        "fr": "❌ Le backtest a échoué (code {rc})",
        "en": "❌ The backtest failed (exit code {rc})",
        "de": "❌ Der Backtest ist fehlgeschlagen (Code {rc})",
        "es": "❌ El backtest falló (código {rc})",
        "it": "❌ Il backtest è fallito (codice {rc})",
        "pt": "❌ O backtest falhou (código {rc})",
        "nl": "❌ De backtest is mislukt (code {rc})",
        "zh": "❌ 回测失败（退出码 {rc}）",
    },
    "no_trades_recorded": {
