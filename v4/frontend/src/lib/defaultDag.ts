...
const NODES_SPEC: NodeSpec[] = [
  ...
  // Col 1 : Funding Carry (autonome — fetch funding + prix en direct)
  {
    ...
    params: { symbol: "BTC/USDT", capital: 2000, fraction: 0.80, min_funding: 0.00001, exit_after_hours: 72, kelly_fraction: 0.35, max_hold_days: 21 },
  ...
  },
  {
    ...
    params: { model: "deepseek-chat", temperature: 0.3, max_tokens: 256, async_mode: false },
